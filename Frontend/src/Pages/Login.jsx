  ...
  return (
    ...
    >
      <form className="space-y-6">
        ...
        <button
          className="w-full py-4 rounded-xl bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-semibold hover:scale-[1.02] transition duration-300 shadow-lg shadow-blue-600/30"
        >
          Login
        </button>
